...
import com.zh.netty.client.handler.TestMessageResponseHandler;
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel socketChannel) {
                        socketChannel
                                ...
                                .addLast(new TestMessageResponseHandler())
                ...
                .addListener(future -> {
                   if (future.isSuccess()) {
                       ...
                       channelFuture.addListener(future1 -> {
                           ...
                           messageRequestPacket.setFromUser(loginRequestPacket.getCode());
                           messageRequestPacket.setToUser("500001");
                           messageRequestPacket.setMessage("第一条消息");
