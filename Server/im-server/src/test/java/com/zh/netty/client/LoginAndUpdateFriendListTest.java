...
import com.zh.netty.client.handler.TestAddFriendResponseHandler;
 ...
 * @author zh2683
 */
public class LoginAndUpdateFriendListTest {
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel socketChannel) {
                        socketChannel
                                ...
                                .addLast(new TestUpdateFriendsResponseHandler())
                ...
                .addListener(future -> {
                   if (future.isSuccess()) {
                       ...
                       channelFuture.addListener(future1 -> {
                           UpdateFriendListRequestPacket updateFriendListRequestPacket = new UpdateFriendListRequestPacket();
                           channel.writeAndFlush(updateFriendListRequestPacket);
                       });
                   } else {
