                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel socketChannel) {
                        socketChannel
                                ...
                                .addLast(new TestAddFriendResponseHandler())
                ...
                .addListener(future -> {
                   if (future.isSuccess()) {
                       ...
                       channelFuture.addListener(future1 -> {
                           // 发送添加朋友请求
                           AddFriendRequestPacket addFriendRequestPacket = new AddFriendRequestPacket();
                           addFriendRequestPacket.setSymbol("500001");
                           channel.writeAndFlush(addFriendRequestPacket);
                       });
                   } else {
